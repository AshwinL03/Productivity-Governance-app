...
const EachProject = () => {
    ...
    useEffect(() => {
        ...
        const mockData = {
            ...
            details: {
                description: "Complete redesign of the e-commerce platform with focus on user experience, performance optimization, and mobile responsiveness.",
            ...
            employees: [
                { id: 1, name: "Sarah Johnson", role: "Senior Developer", hours: 78, contribution: "92%" },
                { id: 2, name: "Michael Chen", role: "Full Stack Developer", hours: 72, contribution: "88%" },
                { id: 3, name: "Emily Rodriguez", role: "UI/UX Designer", hours: 56, contribution: "78%" },
                { id: 4, name: "David Kim", role: "Backend Developer", hours: 35, contribution: "65%" },
                { id: 5, name: "Lisa Wang", role: "QA Engineer", hours: 12, contribution: "42%" },
            ],
            // New Data for Graph
            dailyEffort: [
            ...
            insights: [
                {
                    ...
                    description: 'Sarah showing 92% utilization - monitor for burnout risk'
                },
                {
                    type: 'danger',
                ...
                },
                {
                    ...
                    description: 'Project maintaining 34-40 hours daily across last 7 days'
                },
                {
                    type: 'info',
